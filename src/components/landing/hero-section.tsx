  ...
  return (
    <section className="relative overflow-hidden px-4 pb-12 pt-32 sm:px-6 sm:pb-16 sm:pt-40 lg:pb-20">
      ...
      <div className="relative z-10 mx-auto max-w-[1180px] text-center">
        <motion.div initial={enter} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }} className="mx-auto mb-7 inline-flex items-center gap-2 rounded-full border border-[#dcd5f7] bg-white/85 px-4.5 py-1.5 text-[10px] font-bold uppercase tracking-[0.16em] text-[#554f65] shadow-sm backdrop-blur sm:text-[11px]">
          <HyperText
            as="span"
            duration={1800}
            delay={200}
            animateOnHover={false}
            className="text-[10px] font-bold uppercase tracking-[0.16em] text-[#554f65] sm:text-[11px]"
          >

        ...
        <div className="flex flex-col items-center justify-center sm:min-h-[160px]">
          <AnimatePresence mode="wait">
            <motion.div
              ...
              className="w-full"
            >
              <h1 className="mx-auto max-w-4xl text-balance text-[clamp(1.85rem,6.5vw,5.5rem)] font-semibold leading-[1.05] tracking-tight text-[#111322] sm:leading-[0.97]">
                {titles[copyIndex]}
              </h1>
              <p className="mx-auto mt-4 sm:mt-6 max-w-[780px] text-balance text-[13px] leading-6 text-[#625d6e] sm:text-[15px] sm:leading-7 lg:text-base">
                {subtitles[copyIndex]}
              </p>
            </motion.div>
          </AnimatePresence>

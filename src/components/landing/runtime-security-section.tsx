...
export default function RuntimeSecuritySection() {
  return (
    <section id="capabilities" className="px-5 pb-20 pt-10 sm:pb-28 sm:pt-14">
        ...
        <div className="mt-10 grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3">
          {capabilities.map((item, index) => (
            <Reveal key={item.title} delay={index * 0.05} className="h-full">
              <div className="group flex h-full flex-col justify-between rounded-[24px] border border-[#e4def5] bg-white p-7 shadow-[0_1px_3px_rgba(17,19,34,.05),0_8px_24px_rgba(109,73,253,.06)] transition-all duration-300 hover:-translate-y-1 hover:border-[#6d49fd]/30 hover:shadow-[0_20px_50px_rgba(45,20,110,.08)]">
                <div>
                ...
                <div
                  className={`flex items-center gap-2.5 truncate rounded-[10px] border px-3.5 py-2.5 font-mono text-[12px] ${
                    item.tagType === "logged"
